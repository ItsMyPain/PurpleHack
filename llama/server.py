...
app.config['BASIC_AUTH_USERNAME'] = os.getenv('LLAMA_USER')
app.config['BASIC_AUTH_PASSWORD'] = os.getenv('LLAMA_PASS')
...
if __name__ == '__main__':
    ...
    app.run(host=os.getenv('LLAMA_HOST'), port=os.getenv('LLAMA_PORT'))
